#  Container-Optimized OS – Versionshinweise
...
**Hinweis:** Die im Änderungslog bereitgestellte Kubernetes-Version entspricht
dem Kubelet und der Kubectl-Version, die mit diesem Container-Optimized OS-
Image geliefert wird. Außerdem kann diese Komponentenversion nicht verwendet
werden, wenn ein GKE-Cluster mit einem Container-Optimized OS-Image ausgeführt
wird.

###  LTS-Image-Serien

  * [ cos-81-lts ](https://cloud.google.com/container-optimized-os/docs/release-notes/m81?hl=de)
...
notes/m73?hl=de) |  19\. März 2019  |  19\. Juni 2020  
[ 69 [LTS] ](https://cloud.google.com/container-optimized-os/docs/release-
notes/m69?hl=de) |  11\. Sep. 2018  |  11\. Dez. 2019  
80  |  11\. Februar 2020  |  20\. März 2020  
...
###  cos-dev-65-10280-0-0
    ...
    Changelog (vs 64-10176-7-0):
        * Recompiled kernel with [RETPOLINE](https://support.google.com/faqs/answer/7625886?hl=de) enabled GCC.
...
**Achtung:** ` cos-dev-64-10173-0-0 ` wurde aufgrund möglicher funktioneller
Regressionen mit dem GCP-Virtualisierungsstack als VERALTET markiert. Diese
Imageversion ist nicht mehr verfügbar, wenn Sie neue Instanzen erstellen, und
alle Versuche, eine Instanz mit dieser Imageversion zu erstellen, schlagen
fehl.
...
(gci-stable-57-9202-74-0 im ` google-containers ` Projekt)
...
(gci-stable-57-9202-64-0 im ` google-containers ` Projekt)
...
(gci-stable-56-9000-104-0 im ` google-containers ` Projekt)
...
(gci-stable-56-9000-103-0 im ` google-containers ` Projekt)
...
(gci-stable-57-9202-56-0 Rollback im ` google-containers ` Projekt)
...
(gci-stable-57-9202-56-0 im ` google-containers ` Projekt)
...
(gci-beta-57-9202-51-0 im ` google-containers ` Projekt)
...
(gci-beta-57-9202-38-0 im ` google-containers ` Projekt)
...
(gci-stable-56-9000-84-2 im ` google-containers ` Projekt)
...
(gci-beta-57-9202-30-0 ` google-containers ` Projekt)
...
(gci-dev-57-9202-26-0 ` google-containers ` Projekt)
...
(gci-dev-57-9202-20-0 ` google-containers ` Projekt)
...
(gci-beta-56-9000-84-0 im ` google-containers ` Projekt)
...
(gci-stable-55-8872-79-0 im ` google-containers ` Projekt)
...
(gci-beta-56-9000-80-0 im ` google-containers ` Projekt)
...
(gci-stable-55-8872-77-0 im ` google-containers ` Projekt)
...
(gci-beta-56-9000-76-0 im ` google-containers ` Projekt)
...
(gci-dev-57-9196-0-0 ` google-containers ` Projekt)
...
###  gci-dev-53-8530-6-0
    ...
    Changelog:
        ...
        * Enabled crash and metrics collection daemons (requires user opt-in, see
        [Configuring a Container-VM instance](https://cloud.google.com/compute/docs/containers/vm-image?hl=de#other_metadata_flags))
