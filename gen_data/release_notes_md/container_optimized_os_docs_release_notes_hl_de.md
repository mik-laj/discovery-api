...
der Kubelet- und der Kubectl-Version, die im Container-Optimized OS-Image
enthalten sind. Außerdem kann diese Komponentenversion nicht verwendet werden,
wenn ein GKE-Cluster mit einem Container-Optimized OS-Image ausgeführt wird.
