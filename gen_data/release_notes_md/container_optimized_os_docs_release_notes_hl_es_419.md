#  Container-Optimized OS para contenedores: notas de la versión

##  Actualizaciones activas en este momento

Las siguientes imágenes están actualmente disponibles en el proyecto de imagen
...
###  Familias de imágenes LTS

  * [ cos-69-lts ](https://cloud.google.com/container-optimized-os/docs/release-notes/m69?hl=es-419)
...
###  cos-dev-65-10280-0-0
    ...
    Changelog (vs 64-10176-7-0):
        * Recompiled kernel with [RETPOLINE](https://support.google.com/faqs/answer/7625886?hl=es-419) enabled GCC.
...
**Precaución:** ` cos-dev-64-10173-0-0 ` se ha marcado como OBSOLETO debido a
posibles regresiones funcionales con la pila de virtualización de GCP. Esta
versión con imágenes ya no está disponible cuando creas nuevas instancias, y
cualquier intento de crear una instancia con esta versión de imagen fallará.
...
(gci-stable-57-9202-74-0 en el proyecto ` google-containers ` )
...
(gci-stable-57-9202-64-0 en el proyecto ` google-containers ` )
...
(gci-stable-56-9000-104-0 en el proyecto ` google-containers ` )
...
(gci-stable-56-9000-103-0 en el proyecto ` google-containers ` )
...
###  cos-stable-57-9202-56-0 reversión

(gci-stable-57-9202-56-0 reversión en el proyecto ` google-containers ` )
...
(gci-stable-57-9202-56-0 en el proyecto ` google-containers ` )
...
(gci-beta-57-9202-51-0 en el proyecto ` google-containers ` )
...
(gci-beta-57-9202-38-0 en el proyecto ` google-containers ` )
...
(gci-stable-56-9000-84-2 en el proyecto ` google-containers ` )
...
(proyecto gci-beta-57-9202-30-0 ` google-containers ` )
...
(proyecto gci-dev-57-9202-26-0 ` google-containers ` )
...
(proyecto gci-dev-57-9202-20-0 ` google-containers ` )
...
(gci-beta-56-9000-84-0 en el proyecto ` google-containers ` )
...
(gci-stable-55-8872-79-0 en el proyecto ` google-containers ` )
...
(gci-beta-56-9000-80-0 en el proyecto ` google-containers ` )
...
(gci-stable-55-8872-77-0 en el proyecto ` google-containers ` )
...
(gci-beta-56-9000-76-0 en el proyecto ` google-containers ` )
...
(proyecto gci-dev-57-9196-0-0 ` google-containers ` )
...
###  gci-dev-53-8530-6-0
    ...
    Changelog:
        ...
        * Enabled crash and metrics collection daemons (requires user opt-in, see
        [Configuring a Container-VM instance](https://cloud.google.com/compute/docs/containers/vm-image?hl=es-419#other_metadata_flags))
