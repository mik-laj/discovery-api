...
corresponde a Kubelet y a la versión de Kubectl que se envían en esa imagen de
Container-Optimized OS. Además, es posible que esta versión del componente no
se pueda usar cuando se ejecuta un clúster de GKE mediante una imagen de
...
(Proyecto ` google-containers ` gci-beta-57-9202-30-0)
...
(Proyecto ` google-containers ` gci-dev-57-9202-26-0)
...
(Proyecto ` google-containers ` de gci-dev-57-9202-20-0)
...
(Proyecto ` google-containers ` gci-dev-57-9196-0-0)
