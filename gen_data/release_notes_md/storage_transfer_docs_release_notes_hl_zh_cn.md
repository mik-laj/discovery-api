...
此页面记录了 Storage Transfer Service 的正式版更新。我们建议 Storage Transfer Service
...
[ Beta stage ](https://cloud.google.com/products/?hl=zh-cn#product-launch-
stages) integration with [ VPC Service Controls
](https://cloud.google.com/vpc-service-controls/docs/overview?hl=zh-cn)
...
service-controls/docs/overview?hl=zh-cn)
...
](https://cloud.google.com/storage-transfer/docs/on-prem-overview?hl=zh-cn) .
...
](https://cloud.google.com/storage-transfer/docs/pub-sub-transfer?hl=zh-cn)
...
transfer/docs/reference/rest/v1/TransferSpec?hl=zh-
cn#ObjectConditions.FIELDS.last_modified_since) .
...
transfer/docs/reference/rest/v1/transferJobs?hl=zh-cn#TransferJob.FIELDS.name)
.
