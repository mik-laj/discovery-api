...
prem/archive/1.1/release-notes?hl=ko) 에서 이러한 취약점은 엠바고가 해제될 때까지 '보안 업데이트'로
...
prem/archive/1.1/downloads?hl=ko#gkectl_latest) 버전으로 [ 업그레이드
](https://cloud.google.com/anthos/gke/docs/on-prem/archive/1.1/how-
to/administration/upgrading-clusters?hl=ko) 하는 것이 좋습니다.
...
prem/archive/1.1/downloads?hl=ko#gkectl_latest)  
