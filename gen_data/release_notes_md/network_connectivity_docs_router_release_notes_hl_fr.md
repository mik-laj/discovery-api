...
connectivity/docs/router/concepts/overview?hl=fr#timer-settings) .
...
connectivity/docs/router/concepts/overview?hl=fr#route-advertisement) is
**Generally Available** .
...
connectivity/docs/router/concepts/overview?hl=fr#route-advertisement) is in
**Beta** .
...
connectivity/docs/router/concepts/overview?hl=fr#dynamic-routing-mode) is
**Generally Available** .
...
connectivity/docs/router/concepts/overview?hl=fr#dynamic-routing-mode) is is
