...
[ Beta stage ](https://cloud.google.com/products/?hl=es-419#product-launch-
stages) integration with [ VPC Service Controls
](https://cloud.google.com/vpc-service-controls/docs/overview?hl=es-419)
...
service-controls/docs/overview?hl=es-419)
...
](https://cloud.google.com/storage-transfer/docs/on-prem-overview?hl=es-419) .
...
](https://cloud.google.com/storage-transfer/docs/pub-sub-transfer?hl=es-419)
...
transfer/docs/reference/rest/v1/TransferSpec?hl=es-419#ObjectConditions.FIELDS.last_modified_since)
.
...
transfer/docs/reference/rest/v1/transferJobs?hl=es-419#TransferJob.FIELDS.name)
.
