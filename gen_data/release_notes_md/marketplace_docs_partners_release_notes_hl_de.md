...
Diese Seite enthält die neuesten Versionshinweise zu Funktionen und Updates
für Google Cloud Marketplace-Partner.
...
](https://cloud.google.com/marketplace/docs/partners/create-quotes?hl=de) .
...
Analytics page
](https://console.cloud.google.com/partner/analytics?_ga=2.65050663.883067678.1580151692-404355855.1580151692&hl=de)
.
...
solutions/support-managed-updates?hl=de) .
...
](https://cloud.google.com/marketplace/docs/partners/payments-reporting?hl=de)
.
...
](https://cloud.google.com/marketplace/docs/partners/integrated-saas/?hl=de) .
...
solutions/select-pricing?hl=de#add-in-partner-portal) .
...
trials, see:
  ...
  * [ Choosing a pricing model for Kubernetes Solutions ](https://cloud.google.com/marketplace/docs/partners/kubernetes-solutions/select-pricing?hl=de)
  * [ Choosing a pricing model for Managed Services ](https://cloud.google.com/marketplace/docs/partners/integrated-saas/select-pricing?hl=de)
...
](https://cloud.google.com/marketplace/docs/partners/?hl=de#supported-
solutions) .
...
](https://cloud.google.com/marketplace/docs/partners/vm/index?hl=de) .
...
solutions/create-app-package?hl=de#on-prem-reqs) , and the [ considerations
for making your application compatible with Istio
](https://cloud.google.com/marketplace/docs/partners/kubernetes-
solutions/create-app-package?hl=de#istio-limitations) .
