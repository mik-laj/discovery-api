...
URL ディレクトリ ` https://cloud.google.com/feeds/datastore-release-notes.xml `
を直接追加します。
...
](https://cloud.google.com/datastore/docs/configure-indexes-rest-api?hl=ja) .
...
entities?hl=ja#exporting_all_entities) .
...
](https://cloud.google.com/firestore/docs/release-notes?hl=ja#january_31_2019)
...
datastore?hl=ja#in_datastore_mode) .
...
](https://cloud.google.com/datastore/docs/activate?hl=ja#datastore-
...
datastore?hl=ja#choosing_a_database) . Datastore mode allows you to use Cloud
...
](https://cloud.google.com/datastore/docs/reference/admin/rest/v1/projects?hl=ja)
, previously in Beta. To learn more about using this service, see:

  * [ Exporting and Importing Entities ](https://cloud.google.com/datastore/docs/export-import-entities?hl=ja)
  * [ Scheduling an Export ](https://cloud.google.com/datastore/docs/schedule-export?hl=ja)
...
import-entities?hl=ja) for Cloud Datastore. Please migrate to the managed
...
](https://cloud.google.com/datastore/docs/reference/data/rest/v1/projects/beginTransaction?hl=ja#TransactionOptions)
...
](https://cloud.google.com/datastore/docs/reference/data/rest/v1/projects/beginTransaction?hl=ja#ReadWrite)
that you are retrying.

**CHANGED:**

Message [ ` BeginTransactionRequest `
](https://cloud.google.com/datastore/docs/reference/data/rest/v1/projects/beginTransaction?hl=ja)
...
Additions to the API definition:
  ...
  * Methods for exporting and importing entities. 
    * [ export ](https://cloud.google.com/datastore/docs/reference/admin/rest/v1beta1/projects/export?hl=ja)
    * [ import ](https://cloud.google.com/datastore/docs/reference/admin/rest/v1beta1/projects/import?hl=ja)
  * Methods for managing long-running operations. 
    * [ cancel ](https://cloud.google.com/datastore/docs/reference/rest/v1/projects.operations/cancel?hl=ja)
    * [ delete ](https://cloud.google.com/datastore/docs/reference/rest/v1/projects.operations/delete?hl=ja)
    * [ get ](https://cloud.google.com/datastore/docs/reference/rest/v1/projects.operations/get?hl=ja)
    * [ list ](https://cloud.google.com/datastore/docs/reference/rest/v1/projects.operations/list?hl=ja)

Additions to the ` gcloud ` command-line tool effective in [ version 169.0.0
](https://cloud.google.com/sdk/docs/release-notes?hl=ja#16900_2017-08-30) :
