...
Translation. Recomendamos que los desarrolladores de AutoML Translation
verifiquen esta lista de forma periódica para consultar los nuevos anuncios.
Los cambios importantes se anunciarán también a través de la lista de
distribución [ google-translate-api
](https://groups.google.com/forum/?hl=es_419#!forum/google-translate-api) .
...
](https://cloud.google.com/translate/automl/docs/evaluate?hl=es_419#evaluate_and_compare_models_using_a_new_test_set)
.
...
](https://cloud.google.com/tpu/docs/tpus?hl=es_419) . Going forward, all
...
](https://cloud.google.com/translate/automl/docs/before-you-begin?hl=es_419) .
...
](https://cloud.google.com/translate/automl/docs/languages?hl=es_419) for the
complete list.
