...
此页面记录了 Anthos GKE on AWS 的产品动态。请查看此页面，了解有关新增功能、更新功能、Bug 修复、已知问题和弃用功能的公告。
...
To upgrade your clusters, perform the following steps:
  ...
  1. Restart your [ control plane instances ](https://cloud.google.com/anthos/gke/docs/aws/troubleshooting?hl=zh-cn#rebooting_your_control_plane) . 
  2. Upgrade your [ management service ](http://cloud.google.com/anthos/gke/docs/aws/how-to/upgrading-management?hl=zh-cn) to aws-1.4.1-gke.17. 
  3. Upgrade your [ user cluster's ](http://cloud.google.com/anthos/gke/docs/aws/how-to/upgrading-user-cluster?hl=zh-cn) AWSCluster and AWSNodePools to 1.16.9-gke.15. 
...
management?hl=zh-cn) and continue with your installation.
...
](https://cloud.google.com/anthos/gke/docs/aws/how-to/uninstalling?hl=zh-cn)
all your management and user clusters. You also need to download the new
version of the [ ` anthos-gke `
](https://cloud.google.com/anthos/gke/docs/aws/downloads?hl=zh-cn#anthos-
...
cluster?hl=zh-cn) . You can enable auto-scaling by changing settings in your
...
](https://cloud.google.com/anthos/gke/docs/aws/concepts/storage.md?hl=zh-cn)
...
](https://cloud.google.com/anthos/gke/docs/aws/reference/awscluster?hl=zh-
cn#speccontrolplane) .
