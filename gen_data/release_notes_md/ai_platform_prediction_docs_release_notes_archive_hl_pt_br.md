...
máquina virtual (VM) [ pré-empacotadas com o JupyterLab
...
uma nova instância do notebook ](https://cloud.google.com/ai-
...
atualizado.
  ...
  * Defina ` machineType ` na [ solicitação ` projects.models.versions.create ` ](https://cloud.google.com/ai-platform/prediction/docs/reference/rest/v1/projects.models.versions?hl=pt_br) para especificar o tipo de máquina a ser usado para veiculação. Use ` mls1-c4-m2 ` para CPUs quad-core. O padrão é a CPU de um núcleo, ` mls1-c1-m2 ` . 
  * Os seguintes nomes de máquina usados na versão Alfa estão **suspensos** : ` mls1-highmem-1 ` e ` mls1-highcpu-4 ` . 
  ...
  * Veja o [ preço atualizado ](https://cloud.google.com/ai-platform/prediction/docs/pricing?hl=pt_br) dos tipos de máquina disponibilizados. 
...
](https://stackoverflow.com/q/52733440) (link em inglês) durante o treinamento
de GPU. A alternativa atual é usar a versão 1.10. Para mais detalhes, consulte
a [ lista de versões de ambiente de execução ](https://cloud.google.com/ai-
platform/prediction/docs/runtime-version-list?hl=pt_br) .
...
A tabela a seguir mostra o preço anterior e o novo:
...
agora está com disponibilidade geral.

  * Defina ` framework ` na [ solicitação ` projects.models.versions.create ` ](https://cloud.google.com/ai-platform/prediction/docs/reference/rest/v1/projects.models.versions?hl=pt_br) para especificar o framework de machine learning ao criar uma versão do modelo. Os valores válidos são: ` TENSORFLOW ` , ` SCIKIT_LEARN ` e ` XGBOOST ` . ` TENSORFLOW ` é o padrão. Se você especificar ` SCIKIT_LEARN ` ou ` XGBOOST ` , também será preciso definir ` runtimeVersion ` como 1.4 ou superior na versão do modelo. 
...
O Python 3.5 está disponível para previsão on-line.
  ...
  * Defina ` pythonVersion ` na [ solicitação ` projects.models.versions.create ` ](https://cloud.google.com/ai-platform/prediction/docs/reference/rest/v1/projects.models.versions?hl=pt_br) para especificar a versão do Python ao criar uma versão de modelo. O padrão é o Python 2.7. 
...
e [ esta postagem do blog ](https://cloud.google.com/blog/big-
data/2017/12/bringing-cloud-ml-engine-to-more-developers-with-online-
prediction-features-and-reduced-prices?hl=pt_br) (em inglês).
...
implantação e na geração de previsões em lote. O recurso de [ ajuste de
hiperparâmetro ](https://cloud.google.com/ml-
...
fórmula de preços aplicada à previsão em lote. Enquanto estiver em Beta, a
previsão on-line não se destinará ao uso em aplicativos críticos.
...
significativas para melhorar o desempenho. Você [ não receberá cobranças
