[ Go 1.13 ](https://cloud.google.com/appengine/docs/standard/go/runtime?hl=fr)
est désormais accessible à tous.

#  Notes de version Go 1.12+
...
](https://cloud.google.com/appengine/docs/standard/go/runtime?hl=fr) for the
