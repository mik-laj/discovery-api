...
2019년 3월 8일에 Cloud ML Engine 런타임 버전 1.9에서 TPU를 사용한 학습 지원이 종료되었습니다. 현재 지원되는 버전은
...
platform/prediction/docs/runtime-version-list?hl=ko) 에 나와 있는 다른 패키지를 포함합니다.
...
자세한 내용은 [ AI Platform Notebooks 개요 ](https://cloud.google.com/ai-
...
platform/prediction/docs/runtime-version-list?hl=ko) 에 나와 있는 다른 패키지도 지원합니다.
...
GPU 학습 중에 [ CuDNN 버전 불일치로 발생한 오류 ](https://stackoverflow.com/q/52733440) 로 인해
Cloud ML Engine 런타임 버전 1.11이 롤백되었습니다. 현재 해결 방법은 런타임 버전 1.10을 사용하는 것입니다. 자세한
내용은 [ 런타임 버전 목록 ](https://cloud.google.com/ai-
platform/prediction/docs/runtime-version-list?hl=ko) 을 참조하세요.
...
이제 학습 및 예측에 Cloud ML Engine 런타임 버전 1.10을 사용할 수 있습니다. 이 버전은 TensorFlow 1.10 및 [
런타임 버전 목록 ](https://cloud.google.com/ai-platform/prediction/docs/runtime-
version-list?hl=ko) 에 나와 있는 다른 패키지를 지원합니다.
...
이제 새로운 두 리전(us-west1, europe-west4)에서 학습을 사용할 수 있습니다. 자세한 내용은 [ 리전
...
이제 **scikit-learn** 및 **XGBoost** 의 온라인 예측 지원이 일반 안정화 버전으로 제공됩니다.
...
자세한 내용은 [ 리전별 제공 여부 ](https://cloud.google.com/ai-
...
AI Platform Prediction의 일반 안정화 버전이 발표되었습니다. 모델 학습, 모델 배포, 일괄 예측 생성용 Cloud ML
...
온라인 예측은 베타 버전으로 제공되며 중요 애플리케이션에서 사용될 수 없습니다.
...
](https://cloud.google.com/ai-platform/prediction/docs/pricing?hl=ko) 이 청구되지
않습니다.
