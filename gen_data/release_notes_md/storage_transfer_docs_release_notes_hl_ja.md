...
このページには、Storage Transfer Service の更新内容が記載されています。Storage Transfer Service
のデベロッパーの方には、ここにリストされる発表内容を定期的に確認されることをおすすめします。
...
[ Beta stage ](https://cloud.google.com/products/?hl=ja#product-launch-stages)
integration with [ VPC Service Controls ](https://cloud.google.com/vpc-
service-controls/docs/overview?hl=ja)

**FEATURE:**

Transfer service on-premises: [ Beta stage
](https://cloud.google.com/products/?hl=ja#product-launch-stages) integration
with [ VPC Service Controls ](https://cloud.google.com/vpc-service-
controls/docs/overview?hl=ja)
...
](https://cloud.google.com/storage-transfer/docs/on-prem-overview?hl=ja) .
...
](https://cloud.google.com/storage-transfer/docs/pub-sub-transfer?hl=ja) for
...
transfer/docs/reference/rest/v1/TransferSpec?hl=ja#ObjectConditions.FIELDS.last_modified_since)
.
...
transfer/docs/reference/rest/v1/transferJobs?hl=ja#TransferJob.FIELDS.name) .
