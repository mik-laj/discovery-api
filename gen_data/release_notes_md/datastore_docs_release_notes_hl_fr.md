...
Cette page répertorie les mises à jour en production de Datastore. Consultez-
...
du flux directement : ` https://cloud.google.com/feeds/datastore-release-
notes.xml `
...
](https://cloud.google.com/datastore/docs/locations?hl=fr) .
...
](https://cloud.google.com/datastore/docs/configure-indexes-rest-api?hl=fr) .
...
entities?hl=fr#exporting_all_entities) .
...
](https://cloud.google.com/firestore/docs/release-notes?hl=fr#january_31_2019)
...
datastore?hl=fr#in_datastore_mode) .
...
](https://cloud.google.com/datastore/docs/upgrade-to-firestore?hl=fr) .
...
](https://cloud.google.com/datastore/docs/activate?hl=fr#datastore-
...
datastore?hl=fr#choosing_a_database) . Datastore mode allows you to use Cloud
...
](https://cloud.google.com/datastore/docs/reference/admin/rest/v1/projects?hl=fr)
, previously in Beta. To learn more about using this service, see:

  * [ Exporting and Importing Entities ](https://cloud.google.com/datastore/docs/export-import-entities?hl=fr)
  * [ Scheduling an Export ](https://cloud.google.com/datastore/docs/schedule-export?hl=fr)
...
import-entities?hl=fr) for Cloud Datastore. Please migrate to the managed
...
](https://cloud.google.com/datastore/docs/reference/data/rest/v1/projects/beginTransaction?hl=fr#TransactionOptions)
...
](https://cloud.google.com/datastore/docs/reference/data/rest/v1/projects/beginTransaction?hl=fr#ReadWrite)
that you are retrying.

**CHANGED:**

Message [ ` BeginTransactionRequest `
](https://cloud.google.com/datastore/docs/reference/data/rest/v1/projects/beginTransaction?hl=fr)
...
Additions to the API definition:
  ...
  * Methods for exporting and importing entities. 
    * [ export ](https://cloud.google.com/datastore/docs/reference/admin/rest/v1beta1/projects/export?hl=fr)
    * [ import ](https://cloud.google.com/datastore/docs/reference/admin/rest/v1beta1/projects/import?hl=fr)
  * Methods for managing long-running operations. 
    * [ cancel ](https://cloud.google.com/datastore/docs/reference/rest/v1/projects.operations/cancel?hl=fr)
    * [ delete ](https://cloud.google.com/datastore/docs/reference/rest/v1/projects.operations/delete?hl=fr)
    * [ get ](https://cloud.google.com/datastore/docs/reference/rest/v1/projects.operations/get?hl=fr)
    * [ list ](https://cloud.google.com/datastore/docs/reference/rest/v1/projects.operations/list?hl=fr)

Additions to the ` gcloud ` command-line tool effective in [ version 169.0.0
](https://cloud.google.com/sdk/docs/release-notes?hl=fr#16900_2017-08-30) :
