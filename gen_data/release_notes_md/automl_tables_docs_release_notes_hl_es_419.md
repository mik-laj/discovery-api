...
En esta página, se presentan las actualizaciones de producción de AutoML
Tables. Puedes revisar esta página de forma periódica para ver anuncios sobre
características nuevas o actualizadas, correcciones de errores, problemas
comunes y funciones obsoletas.

Para obtener una lista de problemas comunes de AutoML Tables, consulta [
Problemas comunes ](https://cloud.google.com/automl-tables/docs/known-
issues?hl=es-419) .
...
service-controls/docs/overview?hl=es-419) is now in [ beta stage
](https://cloud.google.com/products/?hl=es-419#product-launch-stages) .
...
Learn more ](https://cloud.google.com/automl-
tables/docs/features?hl=es-419#local) .
...
](https://cloud.google.com/automl-tables/docs/locations?hl=es-419) .
...
](https://cloud.google.com/automl-tables/docs/model-export?hl=es-419) .
...
](https://cloud.google.com/automl-tables/docs/logging?hl=es-419) .
...
**CHANGED:**
  ...
  * Support for **Precision at recall** and **Recall at precision** optimization objectives for classification models. [ Learn more ](https://cloud.google.com/automl-tables/docs/train?hl=es-419#opt-obj) . 
...
](https://cloud.google.com/automl-tables/docs/client-libraries?hl=es-419) .
...
tables/docs/known-issues?hl=es-419#fixed) .
...
](https://cloud.google.com/automl-tables/docs/train?hl=es-419) .
...
](https://cloud.google.com/automl-tables/docs/predict-batch?hl=es-419#csv-
results) .
...
tables/docs/models?hl=es-419#deploy) .
