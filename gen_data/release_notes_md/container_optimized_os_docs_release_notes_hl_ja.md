#  Container-Optimized OS - リリースノート

##  現在有効なリリース

現在、 ` cos-cloud ` イメージ プロジェクトで次のイメージを利用できます。  Stable  |  Beta  |  開発  
---|---|---  
...
**注:** 変更履歴に記載の Kubernetes バージョンは、そのコンテナ用に最適化された OS イメージに付属する Kubelet と
Kubectl バージョンに対応しています。また、Container-Optimized OS イメージを使用して GKE
クラスタを実行する場合、これらのコンポーネント バージョンは使用できません。
...
76  |  2019 年 8 月 6 日  |  2019 年 9 月 27 日  
75  |  2019 年 6 月 11 日  |  2019 年 8 月 6 日  
74  |  2019 年 4 月 30 日  |  2019 年 6 月 11 日  
72  |  2019 年 2 月 5 日  |  2019 年 3 月 25 日  
71  |  2018 年 12 月 4 日  |  2019 年 2 月 14 日  
70  |  2018 年 10 月 23 日  |  2018 年 12 月 14 日  
...
###  cos-dev-74-11892-0-0
    ...
    Changelog (vs 74-11888-0-0):
        * Enabled Shielded VMs. Instances created from this image will use UEFI
        ...
        [here](https://cloud.google.com/shielded-vm/?hl=ja) to learn more about Shielded VMs.
...
###  cos-dev-65-10280-0-0
    ...
    Changelog (vs 64-10176-7-0):
        * Recompiled kernel with [RETPOLINE](https://support.google.com/faqs/answer/7625886?hl=ja) enabled GCC.
...
**注意:** ` cos-dev-64-10173-0-0 ` は、GCP
仮想化スタックとの組み合わせで機能が低下する可能性があるため、廃止となっています。新規インスタンスの作成時にこのイメージ
バージョンを選択することはできません。また、このバージョンでインスタンスを作成しようとすると失敗します。
...
（ ` google-containers ` プロジェクトの gci-stable-57-9202-74-0）
...
（ ` google-containers ` プロジェクトの gci-stable-57-9202-64-0）
...
（ ` google-containers ` プロジェクトの gci-stable-56-9000-104-0）
...
（ ` google-containers ` プロジェクトの gci-stable-56-9000-103-0）
...
###  cos-stable-57-9202-56-0 ロールバック

（ ` google-containers ` プロジェクトの gci-stable-57-9202-56-0 ロールバック）
...
（ ` google-containers ` プロジェクトの gci-stable-57-9202-56-0）
...
（ ` google-containers ` プロジェクトの gci-beta-57-9202-51-0）
...
（ ` google-containers ` プロジェクトの gci-beta-57-9202-38-0）
...
（ ` google-containers ` プロジェクトの gci-stable-56-9000-84-2）
...
（ ` google-containers ` プロジェクトの gci-beta-57-9202-30-0）
...
（ ` google-containers ` プロジェクトの gci-dev-57-9202-26-0）
...
（ ` google-containers ` プロジェクトの gci-dev-57-9202-20-0）
...
（ ` google-containers ` プロジェクトの gci-beta-56-9000-84-0）
...
（ ` google-containers ` プロジェクトの gci-stable-55-8872-79-0）
...
（ ` google-containers ` プロジェクトの gci-beta-56-9000-80-0）
...
（ ` google-containers ` プロジェクトの gci-stable-55-8872-77-0）
...
（ ` google-containers ` プロジェクトの gci-beta-56-9000-76-0）
...
（ ` google-containers ` プロジェクトの gci-dev-57-9196-0-0）
...
###  gci-dev-53-8530-6-0
    ...
    Changelog:
        ...
        * Enabled crash and metrics collection daemons (requires user opt-in, see
        [Configuring a Container-VM instance](https://cloud.google.com/compute/docs/containers/vm-image?hl=ja#other_metadata_flags))
