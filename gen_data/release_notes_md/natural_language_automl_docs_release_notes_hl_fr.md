...
Cette page répertorie les mises à jour en production d'AutoML Natural
Language. Consultez-la régulièrement pour obtenir des informations sur les
...
du flux directement : ` https://cloud.google.com/feeds/automl-language-
release-notes.xml `
...
language/automl/docs/languages?hl=fr#classification) .
...
language/automl/docs/languages?hl=fr#entity_analysis) .
...
](https://cloud.google.com/natural-language/automl/docs/?hl=fr) for details
about all features.
...
](https://cloud.google.com/natural-language/automl/docs/locations?hl=fr) for
more information.
...
](https://cloud.google.com/natural-language/automl/docs/predict?hl=fr) .
...
analysis/docs/datasets?hl=fr#label-items) for more information.
