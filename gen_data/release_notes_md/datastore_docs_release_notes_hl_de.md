...
Auf dieser Seite werden Produktionsaktualisierungen von Datastore
...
](https://cloud.google.com/datastore/docs/locations?hl=de) .
...
](https://cloud.google.com/datastore/docs/configure-indexes-rest-api?hl=de) .
...
entities?hl=de#exporting_all_entities) .
...
](https://cloud.google.com/firestore/docs/release-notes?hl=de#january_31_2019)
...
datastore?hl=de#in_datastore_mode) .
...
](https://cloud.google.com/datastore/docs/upgrade-to-firestore?hl=de) .
...
](https://cloud.google.com/datastore/docs/activate?hl=de#datastore-
...
datastore?hl=de#choosing_a_database) . Datastore mode allows you to use Cloud
...
](https://cloud.google.com/datastore/docs/reference/admin/rest/v1/projects?hl=de)
, previously in Beta. To learn more about using this service, see:

  * [ Exporting and Importing Entities ](https://cloud.google.com/datastore/docs/export-import-entities?hl=de)
  * [ Scheduling an Export ](https://cloud.google.com/datastore/docs/schedule-export?hl=de)
...
import-entities?hl=de) for Cloud Datastore. Please migrate to the managed
...
](https://cloud.google.com/datastore/docs/reference/data/rest/v1/projects/beginTransaction?hl=de#TransactionOptions)
...
](https://cloud.google.com/datastore/docs/reference/data/rest/v1/projects/beginTransaction?hl=de#ReadWrite)
that you are retrying.

**CHANGED:**

Message [ ` BeginTransactionRequest `
](https://cloud.google.com/datastore/docs/reference/data/rest/v1/projects/beginTransaction?hl=de)
...
Additions to the API definition:
  ...
  * Methods for exporting and importing entities. 
    * [ export ](https://cloud.google.com/datastore/docs/reference/admin/rest/v1beta1/projects/export?hl=de)
    * [ import ](https://cloud.google.com/datastore/docs/reference/admin/rest/v1beta1/projects/import?hl=de)
  * Methods for managing long-running operations. 
    * [ cancel ](https://cloud.google.com/datastore/docs/reference/rest/v1/projects.operations/cancel?hl=de)
    * [ delete ](https://cloud.google.com/datastore/docs/reference/rest/v1/projects.operations/delete?hl=de)
    * [ get ](https://cloud.google.com/datastore/docs/reference/rest/v1/projects.operations/get?hl=de)
    * [ list ](https://cloud.google.com/datastore/docs/reference/rest/v1/projects.operations/list?hl=de)

Additions to the ` gcloud ` command-line tool effective in [ version 169.0.0
](https://cloud.google.com/sdk/docs/release-notes?hl=de#16900_2017-08-30) :
