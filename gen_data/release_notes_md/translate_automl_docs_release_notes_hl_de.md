...
Diese Seite enthält die Produktionsaktualisierungen von AutoML Translation.
Wir empfehlen AutoML Translation-Entwicklern, diese Liste regelmäßig auf neue
Ankündigungen zu prüfen. Wesentliche Änderungen werden auch über die
Mailingliste [ google-translate-api
...
](https://cloud.google.com/tpu/docs/tpus?hl=de) . Going forward, all training
...
](https://cloud.google.com/translate/automl/docs/before-you-begin?hl=de) .
...
](https://cloud.google.com/translate/automl/docs/languages?hl=de) for the
complete list.
