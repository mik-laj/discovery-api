...
dokumentiert. Hier finden Sie Ankündigungen zu neuen oder aktualisierten
Funktionen, Fehlerbehebungen, bekannten Problemen und veralteten Funktionen.
...
To upgrade your clusters, perform the following steps:
  ...
  1. Restart your [ control plane instances ](https://cloud.google.com/anthos/gke/docs/aws/troubleshooting?hl=de#rebooting_your_control_plane) . 
  2. Upgrade your [ management service ](http://cloud.google.com/anthos/gke/docs/aws/how-to/upgrading-management?hl=de) to aws-1.4.1-gke.17. 
  3. Upgrade your [ user cluster's ](http://cloud.google.com/anthos/gke/docs/aws/how-to/upgrading-user-cluster?hl=de) AWSCluster and AWSNodePools to 1.16.9-gke.15. 
...
management?hl=de) and continue with your installation.
...
](https://cloud.google.com/anthos/gke/docs/aws/how-to/uninstalling?hl=de) all
your management and user clusters. You also need to download the new version
of the [ ` anthos-gke `
](https://cloud.google.com/anthos/gke/docs/aws/downloads?hl=de#anthos-
...
cluster?hl=de) . You can enable auto-scaling by changing settings in your
...
](https://cloud.google.com/anthos/gke/docs/aws/concepts/storage.md?hl=de)
...
](https://cloud.google.com/anthos/gke/docs/aws/reference/awscluster?hl=de#speccontrolplane)
.
