...
このページには AutoML Translation に関する更新内容が記載されています。AutoML Translation
デベロッパーの方には、ここにリストされる発表内容を定期的に確認されることをおすすめします。重要な変更については、 [ google-translate-
...
](https://cloud.google.com/tpu/docs/tpus?hl=ja) . Going forward, all training
...
](https://cloud.google.com/translate/automl/docs/before-you-begin?hl=ja) .
...
](https://cloud.google.com/translate/automl/docs/languages?hl=ja) for the
complete list.
