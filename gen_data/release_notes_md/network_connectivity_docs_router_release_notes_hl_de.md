...
connectivity/docs/router/concepts/overview?hl=de#timer-settings) .
...
connectivity/docs/router/concepts/overview?hl=de#route-advertisement) is
**Generally Available** .
...
connectivity/docs/router/concepts/overview?hl=de#route-advertisement) is in
**Beta** .
...
connectivity/docs/router/concepts/overview?hl=de#dynamic-routing-mode) is
**Generally Available** .
...
connectivity/docs/router/concepts/overview?hl=de#dynamic-routing-mode) is is
