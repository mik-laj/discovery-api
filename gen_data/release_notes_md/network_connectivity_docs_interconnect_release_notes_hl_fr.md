...
Cette page contient les notes de version associées aux fonctionnalités et
mises à jour de Cloud Interconnect.
...
du flux directement : ` https://cloud.google.com/feeds/cloudinterconnect-
release-notes.xml `
...
to/dedicated/modifying-vlan-attachments?hl=fr) a VLAN attachment through
...
For Google Cloud Interconnect - Dedicated, setting a VLAN attachment's
capacity and [ modifying ](https://cloud.google.com/interconnect/docs/how-
to/dedicated/modifying-vlan-attachments?hl=fr) a VLAN attachment are available
in **Beta** .
