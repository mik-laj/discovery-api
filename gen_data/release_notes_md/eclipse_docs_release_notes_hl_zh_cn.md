...
本页面记录了 Cloud Tools for Eclipse 的正式版更新。您可以通过本页面查阅有关新增功能、更新功能、问题修复、已知问题和弃用功能的公告。
...
](https://cloud.google.com/eclipse/docs/manage-sdk?hl=zh-cn) guide, including
...
](https://cloud.google.com/sdk/downloads?hl=zh-cn#versioned) and point Cloud
