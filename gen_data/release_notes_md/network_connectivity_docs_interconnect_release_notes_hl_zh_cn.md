...
本页面包含关于 Cloud Interconnect 特性和更新的版本说明。
...
to/dedicated/modifying-vlan-attachments?hl=zh-cn) a VLAN attachment through
...
For Google Cloud Interconnect - Dedicated, setting a VLAN attachment's
capacity and [ modifying ](https://cloud.google.com/interconnect/docs/how-
to/dedicated/modifying-vlan-attachments?hl=zh-cn) a VLAN attachment are
available in **Beta** .
