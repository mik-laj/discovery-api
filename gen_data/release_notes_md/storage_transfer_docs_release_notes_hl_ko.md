...
이 페이지에서는 Storage Transfer Service의 프로덕션 업데이트를 설명합니다. Storage Transfer Service
개발자는 정기적으로 이 목록에서 새로운 공지 사항을 확인하는 것이 좋습니다.
...
[ Beta stage ](https://cloud.google.com/products/?hl=ko#product-launch-stages)
integration with [ VPC Service Controls ](https://cloud.google.com/vpc-
service-controls/docs/overview?hl=ko)

**FEATURE:**

Transfer service on-premises: [ Beta stage
](https://cloud.google.com/products/?hl=ko#product-launch-stages) integration
with [ VPC Service Controls ](https://cloud.google.com/vpc-service-
controls/docs/overview?hl=ko)
...
](https://cloud.google.com/storage-transfer/docs/on-prem-overview?hl=ko) .
...
](https://cloud.google.com/storage-transfer/docs/pub-sub-transfer?hl=ko) for
...
transfer/docs/reference/rest/v1/TransferSpec?hl=ko#ObjectConditions.FIELDS.last_modified_since)
.
...
transfer/docs/reference/rest/v1/transferJobs?hl=ko#TransferJob.FIELDS.name) .
