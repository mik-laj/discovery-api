...
This page documents production updates to the Vision API. We recommend that
Vision developers periodically check this list for any new announcements.
...
same [ Service Level Agreement ](https://cloud.google.com/vision/sla) .
...
](https://cloud.google.com/vision/docs/ocr) ( ` us ` and ` eu ` ) for the OCR
feature.
...
The following beta features are available in API version **v1p4beta1** :
  ...
  * Celebrity recognition. For more information, see [ Celebrity recognition ](https://cloud.google.com/vision/docs/celebrity-recognition) . 
...
requests. For more infomation, see the OCR how-to pages:
  ...
  * [ Detect text in images ](https://cloud.google.com/vision/docs/ocr#regionalization)
  * [ Detect handwriting in images ](https://cloud.google.com/vision/docs/handwriting#regionalization)
  * [ Detect text in files (PDF/TIFF) ](https://cloud.google.com/vision/docs/pdf#regionalization)
...
](https://cloud.google.com/vision/docs/adding-spring) . Spring Cloud Vision
can make it easier and more efficient to work with Cloud Vision.
...
image annotation ](https://cloud.google.com/vision/docs/batch) .
...
Feature ` object to use the new models.
...
](https://cloud.google.com/vision/docs/languages#supported-langs) by `
TEXT_DETECTION ` and ` DOCUMENT_TEXT_DETECTION ` . [ Experimentally supported
](https://cloud.google.com/vision/docs/languages#experimental-langs) languages
and [ mapped languages
](https://cloud.google.com/vision/docs/languages#mapped-langs) lists have also
been added.
...
notes#september2018) is now the default for [ Text detection (OCR)
...
Improved detection models are now available for the following features:
  ...
  * [ Logo Detection ](https://cloud.google.com/vision/docs/detecting-logos)
  * [ Text Detection (OCR) ](https://cloud.google.com/vision/docs/detecting-text)
...
The following beta features are available in API version **v1p3beta1** :
  ...
  * Object localizer. For more information, see [ Detect multiple objects ](https://cloud.google.com/vision/docs/object-localizer) . 
...
](https://cloud.google.com/vision/docs/ocr#detecting_handwriting) .
...
](https://cloud.google.com/vision/docs/release-notes#december2017) are now
available in the v1 API (GA). These include:
...
The following beta features are available in API version **v1p1beta1** :
  ...
  * Document text detection: confidence scores for all levels of results, auto language detection, support for multiple languages, and faster and more accurate results. [ Learn more ](https://cloud.google.com/vision/docs/beta-ocr) . 
  * Web entities detection: accepts geotag input as detection hint, and returns best guess labels describing the contents of the image. [ Learn more ](https://cloud.google.com/vision/docs/beta-web-entities) . 
  * Safe Search detection: includes additional ` racy ` category to enhance adult content moderation. [ Learn more ](https://cloud.google.com/vision/docs/beta-explicit-content) . 
...
](https://cloud.google.com/vision/docs/detecting-text) model has been updated
to improve quality. There is no change in response structure.

**CHANGED:**

**Label detection model update** : The [ label detection
](https://cloud.google.com/vision/docs/detecting-labels) model has been
...
web) and [ tutorial ](https://cloud.google.com/vision/docs/internet-detection)
.

**FEATURE:**

**Document text detection** : Return full text annotations for dense OCR text.
[ How-to ](https://cloud.google.com/vision/docs/ocr) , [ code samples
](https://cloud.google.com/vision/docs/detecting-fulltext) , and [ tutorial
