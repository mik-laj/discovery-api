...
本页面包含关于 Cloud Router 特性和更新的版本说明。
...
connectivity/docs/router/concepts/overview?hl=zh-cn#timer-settings) .
...
connectivity/docs/router/concepts/overview?hl=zh-cn#route-advertisement) is
**Generally Available** .
...
connectivity/docs/router/concepts/overview?hl=zh-cn#route-advertisement) is in
**Beta** .
...
connectivity/docs/router/concepts/overview?hl=zh-cn#dynamic-routing-mode) is
**Generally Available** .
