...
Auf dieser Seite werden Produktionsupdates für Speech-to-Text dokumentiert.
...
](https://cloud.google.com/speech-to-text/docs/languages?hl=de) : Burmese,
Estonian, Uzbek, Punjabi, Albanian, Macedonian, and Mongolian.

**FEATURE:**

The [ speaker diarization ](https://cloud.google.com/speech-to-
text/docs/multiple-voices?hl=de) , [ automatic punctuation
](https://cloud.google.com/speech-to-text/docs/automatic-punctuation?hl=de) ,
[ speech adaptation boost ](https://cloud.google.com/speech-to-
text/docs/boost?hl=de) , and [ enhanced telephony model
](https://cloud.google.com/speech-to-text/docs/enhanced-models?hl=de) features
are now available for new languages. See the supported [ languages page
](https://cloud.google.com/speech-to-text/docs/languages?hl=de) for a complete
list.

**CHANGED:**

[ Class tokens ](https://cloud.google.com/speech-to-text/docs/class-
tokens?hl=de) are now available for general use. You can use class tokens with
[ speech adaptation ](https://cloud.google.com/speech-to-text/docs/speech-
adaptation?hl=de#classes) to help the model recognize concepts in your
recorded audio data.
...
text/docs/automatic-punctuation?hl=de) is now available for general use. Cloud
...
tutorial?hl=de) that demonstrate how to transcribe an infinite audio stream.

**FEATURE:**

You can now use [ speech adaptation ](https://cloud.google.com/speech-to-
text/docs/context-strength?hl=de) to provide 'hints' to Cloud Speech-to-Text
...
recognize?hl=de) . To use streaming recognition with the 5 minute limit, you
must use the [ ` v1p1beta1 ` ](https://cloud.google.com/speech-to-
text/docs/reference/rpc/google.cloud.speech.v1p1beta1?hl=de#speech) API
version.

**FEATURE:**

Cloud Speech-to-Text now supports transcription of [ MP3 encoded audio data
](https://cloud.google.com/speech-to-text/docs/encoding?hl=de) . As this
...
text/docs/reference/rpc/google.cloud.speech.v1?hl=de) or [ ` v1p1beta1 `
](https://cloud.google.com/speech-to-
text/docs/reference/rpc/google.cloud.speech.v1p1beta1?hl=de) version of the
API.
...
logging?hl=de) is now available for general use. When you enable data logging,
...
models?hl=de) are now available for general use. Using enhanced models can
improve audio transcription results.

**CHANGED:**

Using [ enhanced models ](https://cloud.google.com/speech-to-
text/docs/enhanced-models?hl=de) no longer requires you to opt-in for data
...
text/pricing?hl=de) as standard models.

**FEATURE:**

[ Selecting a transcription model ](https://cloud.google.com/speech-to-
text/docs/transcription-model?hl=de) is now available for general use. You can
...
channels ](https://cloud.google.com/speech-to-text/docs/multi-channel?hl=de) .
...
metadata?hl=de) , which can improve the results of the speech recognition.
This feature is now available for general use.
...
](https://cloud.google.com/speech-to-text/docs/word-confidence?hl=de)
...
](https://cloud.google.com/speech-to-text/docs/multiple-languages?hl=de) in
their transcription request. This feature is in Beta.

**FEATURE:**

Cloud Speech-to-Text can [ identify different speakers
](https://cloud.google.com/speech-to-text/docs/multiple-voices?hl=de) present
...
](https://cloud.google.com/speech-to-text/docs/data-logging?hl=de) and [
enhanced models ](https://cloud.google.com/speech-to-text/docs/enhanced-
models?hl=de) . Developers that want to take advantage of the enhanced speech
recognition models can [ opt-in for data logging
](https://cloud.google.com/speech-to-text/docs/data-logging-terms?hl=de) .
This feature is in Beta.
...
model?hl=de) . This feature is in Beta.
...
text/docs/basics?hl=de#time-offsets) .
...
](https://cloud.google.com/speech-to-text/docs/languages?hl=de) .
...
](https://cloud.google.com/speech-to-text/quotas?hl=de) . For more information
on asynchronous recognition requests, see the [ transcribing long audio files
guide ](https://cloud.google.com/speech-to-text/docs/async-recognize?hl=de) .
...
in the [ terms of service ](https://cloud.google.com/terms?hl=de) . To avoid
