#  Container-Optimized OS - 출시 노트

##  현재 활성 출시 버전

다음 이미지는 현재 ` cos-cloud ` 이미지 프로젝트에서 사용할 수 있습니다.  정식  |  베타  |  개발자  
---|---|---  
...
###  LTS 이미지 계열
  ...
  * [ cos-69-lts ](https://cloud.google.com/container-optimized-os/docs/release-notes/m69?hl=ko)
...
###  cos-dev-65-10280-0-0
    ...
    Changelog (vs 64-10176-7-0):
        * Recompiled kernel with [RETPOLINE](https://support.google.com/faqs/answer/7625886?hl=ko) enabled GCC.
...
**주의:** ` cos-dev-64-10173-0-0 ` 은 GCP 가상화 스택과의 잠재적 기능 회귀로 인해 OBSOLETE로
표시되었습니다. 새 인스턴스를 만들 때 이 이미지 버전을 더 이상 사용할 수 없으므로 이 이미지 버전으로 인스턴스를 만들려는 모든 시도가
실패합니다.
...
( ` google-containers ` 프로젝트의 gci-stable-57-9202-74-0)
...
( ` google-containers ` 프로젝트의 gci-stable-57-9202-64-0)
...
( ` google-containers ` 프로젝트의 gci-stable-56-9000-104-0)
...
( ` google-containers ` 프로젝트의 gci-stable-56-9000-103-0)
...
###  cos-stable-57-9202-56-0 롤백

( ` google-containers ` 프로젝트의 gci-stable-57-9202-56-0 롤백)
...
( ` google-containers ` 프로젝트의 gci-stable-57-9202-56-0)
...
( ` google-containers ` 프로젝트의 gci-beta-57-9202-51-0)
...
( ` google-containers ` 프로젝트의 gci-beta-57-9202-38-0)
...
( ` google-containers ` 프로젝트의 gci-stable-56-9000-84-2)
...
( ` google-containers ` 프로젝트의 gci-beta-57-9202-30)
...
( ` google-containers ` 프로젝트의 gci-dev-57-9202-26-0)
...
( ` google-containers ` 프로젝트의 gci-dev-57-9202-20-0)
...
( ` google-containers ` 프로젝트의 gci-beta-56-9000-84-0)
...
( ` google-containers ` 프로젝트의 gci-stable-55-8872-79-0)
...
( ` google-containers ` 프로젝트의 gci-beta-56-9000-80-0)
...
( ` google-containers ` 프로젝트의 gci-stable-55-8872-77-0)
...
( ` google-containers ` 프로젝트의 gci-beta-56-9000-76-0)
...
( ` google-containers ` 프로젝트의 gci-dev-57-9196-0-0)
...
###  gci-dev-53-8530-6-0
    ...
    Changelog:
        ...
        * Enabled crash and metrics collection daemons (requires user opt-in, see
        [Configuring a Container-VM instance](https://cloud.google.com/compute/docs/containers/vm-image?hl=ko#other_metadata_flags))
