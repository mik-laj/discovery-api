...
本页面记录了 Datastore 的正式版更新。您可以定期查看此页面，了解有关新增功能、功能更新、问题修复、已知问题和弃用功能的公告。
...
https://cloud.google.com/feeds/datastore-release-notes.xml `
...
](https://cloud.google.com/datastore/docs/locations?hl=zh-cn) .
...
](https://cloud.google.com/datastore/docs/configure-indexes-rest-api?hl=zh-cn)
.
...
entities?hl=zh-cn#exporting_all_entities) .
...
](https://cloud.google.com/firestore/docs/release-notes?hl=zh-
cn#january_31_2019) Cloud Firestore is the new version of Cloud Datastore and
includes a backwards-compatible [ Datastore mode
](https://cloud.google.com/firestore/docs/firestore-or-datastore?hl=zh-
cn#in_datastore_mode) .
...
](https://cloud.google.com/datastore/docs/upgrade-to-firestore?hl=zh-cn) .
...
](https://cloud.google.com/datastore/docs/activate?hl=zh-cn#datastore-
...
](https://cloud.google.com/datastore/docs/firestore-or-datastore?hl=zh-
cn#choosing_a_database) . Datastore mode allows you to use Cloud Datastore
...
](https://cloud.google.com/datastore/docs/reference/admin/rest/v1/projects?hl=zh-
cn) , previously in Beta. To learn more about using this service, see:

  * [ Exporting and Importing Entities ](https://cloud.google.com/datastore/docs/export-import-entities?hl=zh-cn)
  * [ Scheduling an Export ](https://cloud.google.com/datastore/docs/schedule-export?hl=zh-cn)
...
import-entities?hl=zh-cn) for Cloud Datastore. Please migrate to the managed
...
](https://cloud.google.com/datastore/docs/reference/data/rest/v1/projects/beginTransaction?hl=zh-
cn#TransactionOptions) object to specify whether the transaction is read-only
or read-write.
...
cn#ReadWrite) that you are retrying.

**CHANGED:**

Message [ ` BeginTransactionRequest `
](https://cloud.google.com/datastore/docs/reference/data/rest/v1/projects/beginTransaction?hl=zh-
cn) adds field ` transactionOptions ` as part of the Data API.
...
Additions to the API definition:
  ...
  * Methods for exporting and importing entities. 
    * [ export ](https://cloud.google.com/datastore/docs/reference/admin/rest/v1beta1/projects/export?hl=zh-cn)
    * [ import ](https://cloud.google.com/datastore/docs/reference/admin/rest/v1beta1/projects/import?hl=zh-cn)
  * Methods for managing long-running operations. 
    * [ cancel ](https://cloud.google.com/datastore/docs/reference/rest/v1/projects.operations/cancel?hl=zh-cn)
    * [ delete ](https://cloud.google.com/datastore/docs/reference/rest/v1/projects.operations/delete?hl=zh-cn)
    * [ get ](https://cloud.google.com/datastore/docs/reference/rest/v1/projects.operations/get?hl=zh-cn)
    * [ list ](https://cloud.google.com/datastore/docs/reference/rest/v1/projects.operations/list?hl=zh-cn)

Additions to the ` gcloud ` command-line tool effective in [ version 169.0.0
](https://cloud.google.com/sdk/docs/release-notes?hl=zh-cn#16900_2017-08-30) :
