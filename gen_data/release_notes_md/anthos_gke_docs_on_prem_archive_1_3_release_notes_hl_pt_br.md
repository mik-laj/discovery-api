Esta é a documentação de uma versão anterior do Anthos GKE On-Prem. [ Veja a
...
Consulte também:
  ...
  * [ Controle de versões e upgrades ](https://cloud.google.com/anthos/gke/docs/on-prem/versioning-and-upgrades?hl=pt-br)
