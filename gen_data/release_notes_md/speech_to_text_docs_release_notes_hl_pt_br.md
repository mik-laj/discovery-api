...
Nesta página, você encontrará atualizações de produção para o Cloud Speech-to-
Text. Verifique-a periodicamente para ver avisos sobre recursos novos ou
...
speech-to-text-release-notes.xml `
...
](https://cloud.google.com/speech-to-text/docs/languages?hl=pt_br) : Burmese,
Estonian, Uzbek, Punjabi, Albanian, Macedonian, and Mongolian.

**FEATURE:**

The [ speaker diarization ](https://cloud.google.com/speech-to-
text/docs/multiple-voices?hl=pt_br) , [ automatic punctuation
](https://cloud.google.com/speech-to-text/docs/automatic-punctuation?hl=pt_br)
, [ speech adaptation boost ](https://cloud.google.com/speech-to-
text/docs/boost?hl=pt_br) , and [ enhanced telephony model
](https://cloud.google.com/speech-to-text/docs/enhanced-models?hl=pt_br)
features are now available for new languages. See the supported [ languages
page ](https://cloud.google.com/speech-to-text/docs/languages?hl=pt_br) for a
complete list.

**CHANGED:**

[ Class tokens ](https://cloud.google.com/speech-to-text/docs/class-
tokens?hl=pt_br) are now available for general use. You can use class tokens
with [ speech adaptation ](https://cloud.google.com/speech-to-
text/docs/speech-adaptation?hl=pt_br#classes) to help the model recognize
...
text/docs/automatic-punctuation?hl=pt_br) is now available for general use.
...
tutorial?hl=pt_br) that demonstrate how to transcribe an infinite audio
stream.

**FEATURE:**

You can now use [ speech adaptation ](https://cloud.google.com/speech-to-
text/docs/context-strength?hl=pt_br) to provide 'hints' to Cloud Speech-to-
...
recognize?hl=pt_br) . To use streaming recognition with the 5 minute limit,
you must use the [ ` v1p1beta1 ` ](https://cloud.google.com/speech-to-
text/docs/reference/rpc/google.cloud.speech.v1p1beta1?hl=pt_br#speech) API
version.

**FEATURE:**

Cloud Speech-to-Text now supports transcription of [ MP3 encoded audio data
](https://cloud.google.com/speech-to-text/docs/encoding?hl=pt_br) . As this
...
text/docs/reference/rpc/google.cloud.speech.v1?hl=pt_br) or [ ` v1p1beta1 `
](https://cloud.google.com/speech-to-
text/docs/reference/rpc/google.cloud.speech.v1p1beta1?hl=pt_br) version of the
API.
...
logging?hl=pt_br) is now available for general use. When you enable data
...
models?hl=pt_br) are now available for general use. Using enhanced models can
improve audio transcription results.

**CHANGED:**

Using [ enhanced models ](https://cloud.google.com/speech-to-
text/docs/enhanced-models?hl=pt_br) no longer requires you to opt-in for data
...
text/pricing?hl=pt_br) as standard models.

**FEATURE:**

[ Selecting a transcription model ](https://cloud.google.com/speech-to-
text/docs/transcription-model?hl=pt_br) is now available for general use. You
...
channel?hl=pt_br) . This feature is now available for general use.
...
metadata?hl=pt_br) , which can improve the results of the speech recognition.
...
](https://cloud.google.com/speech-to-text/docs/word-confidence?hl=pt_br)
...
](https://cloud.google.com/speech-to-text/docs/multiple-languages?hl=pt_br) in
their transcription request. This feature is in Beta.

**FEATURE:**

Cloud Speech-to-Text can [ identify different speakers
](https://cloud.google.com/speech-to-text/docs/multiple-voices?hl=pt_br)
...
Cloud Speech-to-Text can transcribe audio data that includes [ multiple
channels ](https://cloud.google.com/speech-to-text/docs/multi-
channel?hl=pt_br) . This feature is in Beta.
...
](https://cloud.google.com/speech-to-text/docs/data-logging?hl=pt_br) and [
enhanced models ](https://cloud.google.com/speech-to-text/docs/enhanced-
models?hl=pt_br) . Developers that want to take advantage of the enhanced
speech recognition models can [ opt-in for data logging
](https://cloud.google.com/speech-to-text/docs/data-logging-terms?hl=pt_br) .
...
model?hl=pt_br) . This feature is in Beta.
...
text/docs/basics?hl=pt_br#time-offsets) .
...
](https://cloud.google.com/speech-to-text/docs/languages?hl=pt_br) .
...
](https://cloud.google.com/speech-to-text/quotas?hl=pt_br) . For more
...
in the [ terms of service ](https://cloud.google.com/terms?hl=pt_br) . To
