#  Container-Optimized OS - Notas da versão
...
notes/m73?hl=pt-br) |  19 de março de 2019  |  19 de junho de 2020  
...
###  cos-dev-65-10280-0-0
    ...
    Changelog (vs 64-10176-7-0):
        * Recompiled kernel with [RETPOLINE](https://support.google.com/faqs/answer/7625886?hl=pt-br) enabled GCC.
...
**Cuidado:** ` cos-dev-64-10173-0-0 ` foi marcado como OBSOLETE devido a
possíveis regressões funcionais com a pilha de virtualização do GCP. Essa
versão de imagem não está mais disponível para criação de novas instâncias. Se
você tentar criar uma instância com ela, ocorrerá uma falha.
...
(gci-stable-57-9202-74-0 no projeto ` google-containers ` )
...
(gci-stable-57-9202-64-0 no projeto ` google-containers ` )
...
(gci-stable-56-9000-104-0 no projeto ` google-containers ` )
...
(gci-stable-56-9000-103-0 no projeto ` google-containers ` )
...
###  reversão cos-stable-57-9202-56-0

(gci-stable-57-9202-56-0 rollback no projeto ` google-containers ` )
...
(gci-stable-57-9202-56-0 no projeto ` google-containers ` )
...
(gci-beta-57-9202-51-0 no projeto ` google-containers ` )
...
(gci-beta-57-9202-38-0 no projeto ` google-containers ` )
...
(gci-stable-56-9000-84-2 no projeto ` google-containers ` )
...
(gci-beta-57-9202-30-0 no projeto ` google-containers ` )
...
(gci-dev-57-9202-26-0 no projeto ` google-containers ` )
...
(gci-dev-57-9202-20-0 no projeto ` google-containers ` )
...
(gci-beta-56-9000-84-0 no projeto ` google-containers ` )
...
(gci-stable-55-8872-79-0 no projeto ` google-containers ` )
...
(gci-beta-56-9000-80-0 no projeto ` google-containers ` )
...
(gci-stable-55-8872-77-0 no projeto ` google-containers ` )
...
(gci-beta-56-9000-76-0 no projeto ` google-containers ` )
...
(gci-dev-57-9196-0-0 no projeto ` google-containers ` )
...
###  gci-dev-53-8530-6-0
    ...
    Changelog:
        ...
        * Enabled crash and metrics collection daemons (requires user opt-in, see
        [Configuring a Container-VM instance](https://cloud.google.com/compute/docs/containers/vm-image?hl=pt-br#other_metadata_flags))
