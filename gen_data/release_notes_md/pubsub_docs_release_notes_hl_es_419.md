...
](https://cloud.google.com/pubsub/docs/reference/libraries?hl=es_419) de
...
](https://github.com/googleapis/google-cloud-python/releases) y [ Ruby
](https://github.com/googleapis/google-cloud-ruby/releases) .

Para recibir las últimas actualizaciones de productos, agrega la URL de esta
página a tu [ lector de feeds
](https://wikipedia.org/wiki/Comparison_of_feed_aggregators) , o agrega
directamente la URL del feed: ` https://cloud.google.com/feeds/cloud-pub-sub-
release-notes.xml `
...
topics?hl=es_419) for Pub/Sub are now available at the [ General Availability
release level ](https://cloud.google.com/products/?hl=es_419#product-launch-
stages) .
...
[ Push subscriptions ](https://cloud.google.com/pubsub/docs/push?hl=es_419)
...
restriction?hl=es_419) are available for Cloud Pub/Sub at the [ General
Availability release level
](https://cloud.google.com/sdk/gcloud/?hl=es_419#release_levels) . This
...
](https://cloud.google.com/pubsub/docs/cmek?hl=es_419) are available at the [
General Availability release level
](https://cloud.google.com/sdk/gcloud/?hl=es_419#release_levels) .
...
](https://cloud.google.com/pubsub/docs/push?hl=es_419#setting_up_for_push_authentication)
...
restriction?hl=es_419) are available for Cloud Pub/Sub at the [ beta release
level ](https://cloud.google.com/sdk/gcloud/?hl=es_419#release_levels) . This
feature allows you to manage the location in which your topics' messages are
stored.
...
[ Custom-managed encryption keys (CMEK)
](https://cloud.google.com/pubsub/docs/cmek?hl=es_419) are in the process of
...
](https://cloud.google.com/pubsub/docs/admin?hl=es_419#modifying_subscription_expiration_policies)
...
[ New pricing ](https://cloud.google.com/pubsub/pricing?hl=es_419) has been
...
[ Seek ](https://cloud.google.com/pubsub/docs/replay-overview?hl=es_419) for
Cloud Pub/Sub is available at the [ General Availability release level
](https://cloud.google.com/sdk/gcloud/?hl=es_419#release_levels) and is
...
[ Labels ](https://cloud.google.com/pubsub/docs/labels?hl=es_419) for Cloud
Pub/Sub are available at the [ General Availability release level
](https://cloud.google.com/sdk/gcloud/?hl=es_419#release_levels) and are
...
](https://cloud.google.com/pubsub/docs/reference/libraries?hl=es_419) are now
...
logging?hl=es_419) for Cloud Pub/Sub is now at the [ General Availability
release level ](https://cloud.google.com/sdk/gcloud/?hl=es_419#release_levels)
...
](https://cloud.google.com/pubsub/docs/reference/libraries?hl=es_419) for
...
](https://cloud.google.com/pubsub/docs/audit-logging?hl=es_419) that enable
...
](https://cloud.google.com/pubsub/docs/reference/rpc/google.pubsub.v1?hl=es_419)
...
](https://cloud.google.com/pubsub/docs/reference/rpc/?hl=es_419) .
...
](https://cloud.google.com/pubsub/pricing?hl=es_419) .
