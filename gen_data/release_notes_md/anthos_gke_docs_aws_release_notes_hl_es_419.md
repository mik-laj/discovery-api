...
on AWS. Consulta esta página para conocer los anuncios sobre funciones nuevas
o actualizadas, las correcciones de errores, los problemas conocidos y las
funciones obsoletas.
...
To upgrade your clusters, perform the following steps:
  ...
  1. Restart your [ control plane instances ](https://cloud.google.com/anthos/gke/docs/aws/troubleshooting?hl=es-419#rebooting_your_control_plane) . 
  2. Upgrade your [ management service ](http://cloud.google.com/anthos/gke/docs/aws/how-to/upgrading-management?hl=es-419) to aws-1.4.1-gke.17. 
  3. Upgrade your [ user cluster's ](http://cloud.google.com/anthos/gke/docs/aws/how-to/upgrading-user-cluster?hl=es-419) AWSCluster and AWSNodePools to 1.16.9-gke.15. 
...
management?hl=es-419) and continue with your installation.
...
](https://cloud.google.com/anthos/gke/docs/aws/how-to/uninstalling?hl=es-419)
all your management and user clusters. You also need to download the new
version of the [ ` anthos-gke `
](https://cloud.google.com/anthos/gke/docs/aws/downloads?hl=es-419#anthos-
...
cluster?hl=es-419) . You can enable auto-scaling by changing settings in your
...
](https://cloud.google.com/anthos/gke/docs/aws/concepts/storage.md?hl=es-419)
...
](https://cloud.google.com/anthos/gke/docs/aws/reference/awscluster?hl=es-419#speccontrolplane)
.
