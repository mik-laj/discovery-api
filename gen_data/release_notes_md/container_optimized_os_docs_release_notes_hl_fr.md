#  Container-Optimized OS – Notes de version
...
###  Familles d'images LTS
  ...
  * [ cos-69-lts ](https://cloud.google.com/container-optimized-os/docs/release-notes/m69?hl=fr)
...
Les dates réelles peuvent changer légèrement.
...
###  cos-dev-65-10280-0-0
    ...
    Changelog (vs 64-10176-7-0):
        * Recompiled kernel with [RETPOLINE](https://support.google.com/faqs/answer/7625886?hl=fr) enabled GCC.
...
**Attention** : ` cos-dev-64-10173-0-0 ` est identifié comme OBSOLÈTE en
raison de régressions fonctionnelles possibles avec la pile de virtualisation
GCP. Cette version d'image n'est plus disponible lorsque vous créez de
nouvelles instances. Toute tentative de création d'une instance avec cette
version d'image échouera.
...
(gci-stable-57-9202-74-0 dans le projet ` google-containers ` )
...
(gci-stable-57-9202-64-0 dans le projet ` google-containers ` )
...
(gci-stable-56-9000-104-0 dans le projet ` google-containers ` )
...
(gci-stable-56-9000-103-0 dans le projet ` google-containers ` )
...
(gci-stable-57-9202-56-0 rollback dans le projet ` google-containers ` )
...
(gci-stable-57-9202-56-0 dans le projet ` google-containers ` )
...
(gci-beta-57-9202-51-0 dans le projet ` google-containers ` )
...
(gci-beta-57-9202-38-0 dans le projet ` google-containers ` )
...
(gci-stable-56-9000-84-2 dans le projet ` google-containers ` )
...
(gci-beta-57-9202-30-0 dans le projet ` google-containers ` )
...
(gci-dev-57-9202-26-0 dans le projet ` google-containers ` )
...
(gci-dev-57-9202-20-0 dans le projet ` google-containers ` )
...
(gci-beta-56-9000-84-0 dans le projet ` google-containers ` )
...
(gci-stable-55-8872-79-0 dans le projet ` google-containers ` )
...
(gci-beta-56-9000-80-0 dans le projet ` google-containers ` )
...
(gci-stable-55-8872-77-0 dans le projet ` google-containers ` )
...
(gci-beta-56-9000-76-0 dans le projet ` google-containers ` )
...
(gci-dev-57-9196-0-0 dans le projet ` google-containers ` )
...
###  gci-dev-53-8530-6-0
    ...
    Changelog:
        ...
        * Enabled crash and metrics collection daemons (requires user opt-in, see
        [Configuring a Container-VM instance](https://cloud.google.com/compute/docs/containers/vm-image?hl=fr#other_metadata_flags))
